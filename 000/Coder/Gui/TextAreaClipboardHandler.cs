...
using IDevTrack.Coder.Document;
using IDevTrack.Coder.Util;

namespace IDevTrack.Coder
{
...
//			((DefaultWorkbench)WorkbenchSingleton.Workbench).UpdateToolbars();
		...
		{
			new IDevTrack.Coder.Actions.Delete().Execute(textArea);
		}
		
		public void SelectAll(object sender, EventArgs e)
		{
			new IDevTrack.Coder.Actions.SelectWholeDocument().Execute(textArea);
		}
